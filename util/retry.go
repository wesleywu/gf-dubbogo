...
func (r *ServiceRetry[Req, Res]) CallDubboGoFunc(ctx context.Context, rpcReq Req, rpcFunc func(context.Context, Req) (Res, error), retryLimit int, retryIntervalMillis int64) (Res, error) {
	var (
		rpcRes Res
		err    error
		retry  = 0
